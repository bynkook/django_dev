...
start "Django Service" cmd /k "call .venv\Scripts\activate & cd django_server & python manage.py runserver 0.0.0.0:8000"

:: 3. FastAPI Gateway (Port 8001 - Public)
...
echo   2. 동료에게 공유 시: 실행창에 'ipconfig'를 입력하여 
echo      IPv4 주소를 확인한 후, [ http://내IP주소:3000 ] 공유
echo ========================================================
pause